...
* English
 ...
 [API Login](/login?redirect=%2Fdev%2Fhowuse%2Fprompt)
...
| --- | --- |
| In the morning sunlight,  a lively Border Collie dog runs joyfully on a green lawn,  this scene is captured in vivid color photography,  conveying a cheerful atmosphere and bright colors. | img |
| On a calm river, an ancient stone bridge is surrounded by weeping willows,  depicted in black and white ink painting,  showing its tranquility and classical beauty under the sunlight,  with strong contrasts between light and shadow in the scene. | img |
| An open ancient book rests on an old wooden table,  softly illuminated by the light of a desk lamp,  surrounded by a dimly lit library environment.  This scene is captured in high-definition photography,  showcasing the serene beauty of knowledge and history. | img |
| In a dry desert environment,  a solitary cactus stands out prominently in the evening glow.  This oil painting captures the cactus’s  resilient vitality and the grandeur of the desert,  with rich and expressive colors. | img |
| A rustic wooden cabin deep in a dense forest,  illuminated by warm lights at night.  This oil painting captures the tranquility  and harmony of the natural surroundings,  using soft tones and delicate lighting,  creating a mysterious yet cozy atmosphere. | img |
