...
- â Don't use instructive language like*no* or*don't*. (e.g., "No walls").
- â Do describe what you don't want to see. (e.g., "wall, frame").
...
|------------------------|-----------------------------------------|----------------------------------------------------------------------------|--------------------------------------------------------------|----------------------------------------------------------------------|
| **Audio**              | Natively generates audio with video.    | Natively generates audio with video.                                       | âï¸ Always on                                                 | â Silent only                                                        |
