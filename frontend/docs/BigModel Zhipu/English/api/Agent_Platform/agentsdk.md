...
| width | string｜ number | Container width (360-840). Values outside range will be clamped |
| height | string｜number | Container height (400-680). Fixed to 100% when type is side |
...
| bubble.bottom | string｜number | Distance from page bottom |
