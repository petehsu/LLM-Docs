...
* English
 ...
 [API Login](/login?redirect=%2Fdev%2Fapi%2Fdevguide%2Fsdk-install)
...
To facilitate user access, we provide both SDK and native HTTP methods for calling the model API. We recommend using the SDK for a better programming experience.

## Installing Python SDK

Python SDK URL: <https://github.com/zhipuai/zhipuai-sdk-python-v4>

First, install the SDK package using the following method:
...
We have upgraded to the latest models GLM-4 and GLM-3-Turbo, which support new features such as System Prompt, FunctionCall, Retrieval, and Web\_Search. To use these new features, you need to upgrade to the latest version of the Python SDK. If you have an older version of the SDK installed, please update to the latest version.
...
Java SDK URL: <https://github.com/zhipuai/zhipuai-sdk-java-v4>

Add the SDK dependency to your Maven project as follows:
