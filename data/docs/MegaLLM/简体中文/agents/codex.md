...
> 配置 Codex 和 Windsurf 使用 MegaLLM
...
<CardGroup cols={2}>
  ...
  <Card title="版本控制" icon="code-branch">
    如果使用 env\_key,可以提交 `config.toml`(没有硬编码密钥)
  </Card>
...
| 功能            | Codex                 | Windsurf              |
| ------------- | --------------------- | --------------------- |
| 基础配置          | <Icon icon="check" /> | <Icon icon="check" /> |
