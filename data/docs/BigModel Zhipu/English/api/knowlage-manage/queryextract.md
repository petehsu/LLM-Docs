...
* English
 ...
 [API Login](/login?redirect=%2Fdev%2Fapi%2Fknowlage-manage%2Fqueryextract)
...
Extracting text information from a file for context-based question answering requires the use of a file upload feature. It is recommended to refer to the [Usage Guide](https://open.bigmodel.cn/dev/howuse/fileqa) .
...
| Request Address | https://open.bigmodel.cn/api/paas/v4/files/{file\_id}/content |
...
# File size limit: no more than 50M, image size limit: no more than 5M, total limit: 100 files
file_object = client.files.create(file=Path("Local file address"), purpose="file-extract")
...
```
{"content":"Document content","file_type":"application/pdf","filename":"Document name.pdf","title":"","type":"file"}
```
